...
// doubly linked list의 특성을 활용하여 Array Vector 생성
// 구현한 Array Vector가 제대로 동작하는지 확인한다.
...
int main() {
	ArrayVector myvector1;
	cout << "element size: " << myvector1.size() << endl;

	// 원하는 index에 element 넣기
	myvector1.insert(0,8);
	cout << "index[0]: " << myvector1.at(0) << endl;
	myvector1.insert(1, 10);
	cout << "index[1]: " << myvector1.at(1) << endl;
	cout << "element size: " << myvector1.size() << endl;
